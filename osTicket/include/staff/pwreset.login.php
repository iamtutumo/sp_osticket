...
<div id="loginBox">
    ...
    <h1 id="logo"><a href="index.php">
        ...
        <img src="logo.php?login" alt="SurePay Ticket :: <?php echo __('Agent Password Reset');?>" />
    </a></h1>
...
<div id="poweredBy"><?php echo __('Powered by'); ?>
    <a href="http://www.surepayltd.com" target="_blank">
        <img alt="SurePay Ticket" src="images/osticket-grey.png" class="osticket-logo">
    </a>
</div>
    <script>
